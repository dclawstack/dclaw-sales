...
> **CRM AI, email sequences, and forecasting**
>
> Sales app in the DClaw Stack. Built with Next.js, FastAPI, PostgreSQL, and the DKube Design System.

[![Status](https://img.shields.io/badge/status-P4%20Planned-F97316)](https://github.com/dclawstack/dclaw-sales)
[![Stack](https://img.shields.io/badge/stack-Next.js%2014%20%2B%20FastAPI%20%2B%20PostgreSQL-purple)](https://docs.dclawstack.io/apps/sales)

---

## Overview

DClaw Sales is an AI-native sales application. It follows the standard DClaw architecture:
...
DClaw Sales uses the **DKube Design System** with its app-specific brand color.
...
export DATABASE_URL="postgresql+asyncpg://postgres:postgres@localhost:5432/dclaw_sales"
...
```bash
ssh root@your-vps
git clone https://github.com/dclawstack/dclaw-sales.git /opt/dclaw-sales
cd /opt/dclaw-sales
docker compose up -d
```

The app will be available at `https://sales.dclawstack.io`.
...
helm upgrade --install dclaw-sales . \
